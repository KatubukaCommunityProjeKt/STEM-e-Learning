...
<div class="flex-container">
    ...
    <div class="contain">
        ...
        <div class="mt-3 mb-3 border-bottom my-12 auto-nav" style="overflow-y:hidden;">
            <span class="card-title" style="padding:30px;"><a href="../../" style="text-decoration:none">Admin</a> > <a href=""> Users > Teachers</a></span>
        </div>
        ...
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="d-flex flex-row p-3">
                 ...
                 <!-- modal form -->
                 <div class="modal fade " id="addTeacher-btn" tabindex="-1" aria-labelledby="studentAdds" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                        <div class="modal-content">
                            <div class="modal-header text-center border-bottom-0">
                                <h5 class="modal-title text-white" style="margin:1px auto;" id="studentAdd-title">Add Teacher's Details</h5>
