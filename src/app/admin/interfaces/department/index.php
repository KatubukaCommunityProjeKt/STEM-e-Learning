...
<div class="flex-container">
    ...
    <div class="sidebar" >
        ...
        <a href="../department" class="nav nav-link active">
    ...
    <div class="contain">
        ...
        <div class="mt-3 mb-3 border-bottom my-12" style="overflow-y:hidden;">
            <span class="card-title" style="padding:30px;">Users > Department</span>
        </div>
        ...
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="text-end mx-5 flex-row d-flex flex-end justify-content-end align-item-center studentAdd">
                    <button type="menu" class="btn btn-default" id="iconbttn"> <i class="bi bi-plus-circle-fill"></i> Add Department</button>
                </div>
