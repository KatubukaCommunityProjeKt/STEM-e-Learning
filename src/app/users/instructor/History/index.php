...
<div class="flex-container">
    ...
    <div class="sidebar" >
        ...
        <a href="../History" class="nav nav-link active justify-content-lg-end align-items-center">
    ...
    <div class="contain">
        ...
        <div class="mt-3 mb-3 border-bottom my-12" style="overflow-y:hidden;">
            <span class="card-title" style="padding:30px;">instructor > History</span>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-end mx-5 flex-row d-flex flex-end justify-content-end align-items-center p-3" id="searchbar">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm table-bordered text-capitalize ">
                        <thead>
                                ...
                                <th scope="col">No. Chall</th>
                                <th scope="col">No. Proj</th>
                                </tr>
                            </thead>
                            <tbody >
                                <tr>
